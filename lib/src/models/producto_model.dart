...
class Productos{
  ...
  Productos.fromJsonList(List<dynamic> jsonList){
    ...
    for (var item in jsonList) {
      producto = Producto.fromJsonMap(item);
...
class Producto {
  ...
  Producto.fromJsonMap(Map<String,dynamic> json){
    ...
    //trabajando 'tags'
    var listAuxTags = json['tags'] as List;
    List<Tag> listaTags = listAuxTags.map((e) => Tag.fromJsonMap(e)).toList();
    //trabajando metadata
    var listAuxMetaData = json['meta_data'] as List;
    List<MetaData> listMetaData = listAuxMetaData.map((e) => MetaData.fromJsonMap(e)).toList();
    ...
    this.dateOnSaleFrom = json['date_on_sale_from']??'';//si es nulo asigne una cadena vacia
    ...
    this.stockQuantity = json['stock_quantity']?? -1;//si es nulo le asigno un valor negativo
    ...
    this.relatedIds = json['related_ids'].cast<int>();
    this.upsellIds = json['upsell_ids'].cast<int>();
    this.crossSellIds = json['cross_sell_ids'].cast<int>();
    ...
    this.variations = json['variations'].cast<int>();
    this.groupedProducts = json['grouped_products'].cast<int>();
    this.menuOrder = json['menu_order'];
    this.metaData = listMetaData;
    this.links = Links.fromJsonMap(json['_links']);
  }
...
class Attribute {
  ...
  Attribute.fromJsonMap(Map<String,dynamic> jsonAttribute){
    ...
    this.options = jsonAttribute['options'].cast<String>();
  }
...
class Download{
  ...
  Download.fromJsonMap(Map<String,dynamic> jsonDown){
    this.id = jsonDown['id'];
    this.name = jsonDown['name'];
    this.file = jsonDown['file'];
  }
...
class Tag{
  ...
  Tag.fromJsonMap(Map<String,dynamic> jsonTag){
      this.id = jsonTag['id'];
      this.name = jsonTag['name'];
      this.slug = jsonTag['slug'];
  }
...
MetaData.fromJsonMap(Map<String,dynamic> jsonMetaData){
  this.id = jsonMetaData['id'];
  this.key = jsonMetaData['key'];
  this.value = jsonMetaData['value'];
}
